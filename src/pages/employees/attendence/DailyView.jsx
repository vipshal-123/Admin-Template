            ...
            <TableBody>
              {filteredAttendence
                ...
                .map((filteredassociate) => {
                  const { _id, empid, name, attendance } = filteredassociate;
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">
                        {attendance[attendance.length - 1]?.punchin}
                      </TableCell>
                      <TableCell align="left">
                        {attendance[attendance.length - 1]?.punchout}
                      </TableCell>
                      <TableCell align="left">
                        {attendance[attendance.length - 1]?.hours}
                      </TableCell>
                      <TableCell align="left">
                        <Label
                          variant="ghost"
                        ...
                        >
                          {attendance[attendance.length - 1]?.attendancetype ===
                            "Present" &&
                          attendance[attendance.length - 1]?.punchin > "09:30"
                            ? "Late"
                            : attendance[attendance.length - 1]?.attendancetype}
                        </Label>
                      </TableCell>
